...
import FantasyPointsChart from "../../components/points_chart/pointschart";
...
const DisplayCard: React.FC<{
    ...
    const data: Stats[] = [
      { title: 'FANTASY POINTS VS MATCHES', stats: [{ key: 'INNINGS', value: '244' }, { key: 'AGGREGATE', value: '8004' }, { key: 'HIGHEST SCORE', value: '113' }, { key: 'AVERAGE', value: '38.67' }, { key: 'FIFTYS', value: '55' }, { key: 'HUNDREDS', value: '8' }, { key: 'DUCKS', value: '10' }, { key: 'FOURS', value: '705' }, { key: 'SIXES', value: '272' },] },
      { title: 'RECENT PERFORMANCE', stats: [{ key: 'X', value: '10' }, { key: 'Y', value: '20' }, { key: 'Z', value: '30' }] },
      { title: 'MATCHUPS', stats: [{ key: 'P', value: '100' }, { key: 'Q', value: '200' }, { key: 'R', value: '300' }] },
      { title: 'PLAYER DEMOGRAPHY', stats: [{ key: 'P', value: '100' }, { key: 'Q', value: '200' }, { key: 'R', value: '300' }] },
      { title: 'Venue Performance Index vs Number of Matches', stats: [{ key: 'P', value: '100' }, { key: 'Q', value: '200' }, { key: 'R', value: '300' }] },      
  ...
  const typeData_2 = Object.values(typesMap).map((type) => ({
    ...
    const handleLeftClickTypes = () => {
      setCurrentIndexTypes((prev) => (prev === 0 ? typeData_2.length - 1 : prev - 1));
    };
  
    const handleRightClickTypes = () => {
      setCurrentIndexTypes((prev) => (prev === typeData_2.length - 1 ? 0 : prev + 1));
    };
  ...
  const handleFilterChange = (filter: string) => {
    ...
    return (
      ...
      !isExpanded ? 
      <div ref={containerRef} className={`display-card ${card.cvc === "C" ? "big" : ( (card.id==="5") || (card.id==="6") || (card.id==="9") || (card.id==="10") ? "middle" : "")}` }>
