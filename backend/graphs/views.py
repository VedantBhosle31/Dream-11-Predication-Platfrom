...
def get_player_points(request, player_id):
    if request.method == 'GET':
        ...
        csv_file_path = 'E:/Dream11/Dream-11-Predication-Platfrom/backend/graphs/dummy_player_data.csv'
...
def get_player_radar_chart(request, player_id):
    if request.method == 'GET':
        ...
        csv_files = {
            'batting': 'E:/Dream11/Dream-11-Predication-Platfrom/backend/graphs/data/dummy_player_batter_data.csv',
            'bowling': 'E:/Dream11/Dream-11-Predication-Platfrom/backend/graphs/data/dummy_player_bowler_data.csv',
            'fielding': 'E:/Dream11/Dream-11-Predication-Platfrom/backend/graphs/data/dummy_player_fielding_data.csv',
        }
