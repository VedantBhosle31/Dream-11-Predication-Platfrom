...
def extract_details(filename):
    ...
    player_details = pd.DataFrame(columns=['date','team', 'runs','1s','2s','4s','6s', 'balls','dots','maidens', 'wickets','caught','bowledlbw',
                                           'bowledlbw_1','bowledlbw_2','bowledlbw_3','wickets_1','wickets_2','wickets_3','maidens_1','maidens_2','maidens_3',
                                           'runs_1','runs_2','runs_3','balls_1','balls_2','balls_3',
                                           'extras','opposition','bowl_first','toss_outcome','venue','bat_innings','outcome','overs'])
    ...
    for ball in innings1:
        for delivery in ball:
            ...
            if 'wicket' in ball[delivery]:
                    ...
                    if 'kind' in ball[delivery]['wicket']:
                        ...
                        if ball[delivery]['wicket']['kind'] == 'bowled' or ball[delivery]['wicket']['kind'] == 'lbw':
                            ...
                            if over_no < 10:
                                player_details.loc[ball[delivery]['bowler'], 'bowledlbw_1'] += 1
                            elif over_no < 40:
                                player_details.loc[ball[delivery]['bowler'], 'bowledlbw_2'] += 1
                            else:
                                player_details.loc[ball[delivery]['bowler'], 'bowledlbw_3'] += 1
                    else:
                        for x in ball[delivery]['wicket']:
                            if 'caught' in x['kind']:
                                player_details.loc[ball[delivery]['bowler'], 'caught'] += 1
            ...
            if over_no < 10:
                ...
                player_details.loc[ball[delivery]['bowler'],'runs_1'] +=  ball[delivery]['runs']['total']
            elif over_no < 40:
                player_details.loc[ball[delivery]['bowler'],'balls_2'] += 1
                player_details.loc[ball[delivery]['bowler'],'runs_2'] +=  ball[delivery]['runs']['total']   
            else:
                player_details.loc[ball[delivery]['bowler'],'balls_3'] += 1
                player_details.loc[ball[delivery]['bowler'],'runs_3'] +=  ball[delivery]['runs']['total']

            player_details.loc[ball[delivery]['bowler'],'runs'] += ball[delivery]['runs']['total']
            player_details.loc[ball[delivery]['bowler'],'dots']  += player_details.loc[ball[delivery]['bowler'],'runs'] == 0
            player_details.loc[ball[delivery]['bowler'],'1s']  += player_details.loc[ball[delivery]['bowler'],'runs'] == 1
            player_details.loc[ball[delivery]['bowler'],'2s']  += player_details.loc[ball[delivery]['bowler'],'runs'] == 2
            player_details.loc[ball[delivery]['bowler'],'4s']  += player_details.loc[ball[delivery]['bowler'],'runs'] == 4
            player_details.loc[ball[delivery]['bowler'],'6s']  += player_details.loc[ball[delivery]['bowler'],'runs'] == 6
        ...
        for ball in innings2:
            for delivery in ball:
                ...
                try:
                    ...
                    player_details.loc[ball[delivery]['bowler'],'toss_outcome'] = 1-toss
                    player_details.loc[ball[delivery]['bowler'], 'runs'] = 0
                    player_details.loc[ball[delivery]['bowler'], '1s'] = 0
                    player_details.loc[ball[delivery]['bowler'], '2s'] = 0
                    player_details.loc[ball[delivery]['bowler'], '4s'] = 0
...
def func(gender, location, formats, matchid_mapping):
    ...
    for format in formats:
        ...
        overall_bowler_details = pd.DataFrame(columns=['team','innings',
                                                'runs','extras',
                                                'balls','1s','2s','4s','6s','dots',
                                                'balls_1','balls_2','balls_3',
                                                'bowledlbw','bowledlbw_1','bowledlbw_2','bowledlbw_3',
                                                'wickets','wickets_1','wickets_2','wickets_3',
                                                'maidens','maidens_1','maidens_2','maidens_3',
                                                'average','strike_rate','economy',
                                                '1haul', '3haul', '5haul']
                                        )
        match_bowler_details = pd.DataFrame(columns=['index','match_id','date','player_id','player_name','team_name','opposition_name','venue_name','innings_played','format',
                                                    'previous_balls_involved','previous_average','previous_strike_rate',
                                                    
                                                    'runs_1','runs_2','runs_3','balls_1','balls_2','balls_3','wickets_1','wickets_2','wickets_3',
                                                    'bowledlbw_1','bowledlbw_2','bowledlbw_3','maidens_1','maidens_2','maidens_3',
                                                    
                                                    'venue_dismissals','venue_innings','venue_economy','venue_average','venue_maidens','venue_bowledlbw',
                                                    
                                                    'previous_wickets','previous_wickets_1','previous_wickets_2','previous_wickets_3',
                                                    'previous_maidens','previous_maidens_1','previous_maidens_2','previous_maidens_3',
                                                    'previous_bowledlbw','previous_bowledlbw_1','previous_bowledlbw_2','previous_bowledlbw_3',
                                                    
                                                    'previous_economy','previous_1haul', 'previous_3haul', 'previous_5haul',
                                                    'runs','extras',
                                                    'balls','1s','2s','4s','6s','balls_involved','maidens',
                                                    'wickets','bowledlbw',
                                                    'average','strike_rate','economy',
                                                    'strike_rate_1','strike_rate_2','strike_rate_3',
                                                    'vboDa_economy_1','vboDa_dismissals_1','vboDa_bowledlbw_1','vboDa_maidens_1','vboDa_economy_2','vboDa_dismissals_2','vboDa_bowledlbw_2','vboDa_maidens_2','vboDa_economy_3','vboDa_dismissals_3','vboDa_bowledlbw_3','vboDa_maidens_3','vboDa_economy_agg','vboDa_dismissals_agg','vboDa_bowledlbw_agg','vboDa_maidens_agg',
                                                    'tboDa_economy_1','tboDa_dismissals_1','tboDa_bowledlbw_1','tboDa_maidens_1','tboDa_economy_2','tboDa_dismissals_2','tboDa_maidens_2','tboDa_bowledlbw_2','tboDa_economy_3','tboDa_dismissals_3','tboDa_bowledlbw_3','tboDa_maidens_3','tboDa_economy_agg','tboDa_dismissals_agg','tboDa_bowledlbw_agg','tboDa_maidens_agg',
                                                    'fboDa_economy_1','fboDa_dismissals_1','fboDa_bowledlbw_1','fboDa_maidens_1','fboDa_economy_2','fboDa_dismissals_2','fboDa_maidens_2','fboDa_bowledlbw_2','fboDa_economy_3','fboDa_dismissals_3','fboDa_bowledlbw_3','fboDa_maidens_3','fboDa_economy_agg','fboDa_dismissals_agg','fboDa_bowledlbw_agg','fboDa_maidens_agg',
        ...
        for ele in date_file_pair:
            ...
            for player in player_details.index:
                ...
                ours = match_bowler_details[(match_bowler_details['venue_name'] == venue) & (match_bowler_details['player_name'] == player)]
                if ours.empty:
                    ...
                    match_bowler_details.loc[count, 'vboDa_economy_1'] = sum(ours['runs_1']) * 6 / (sum(ours['balls_1']) if sum(ours['balls_1']) != 0 else 1)
                    match_bowler_details.loc[count, 'vboDa_economy_2'] = sum(ours['runs_2']) * 6 / (sum(ours['balls_2']) if sum(ours['balls_2']) != 0 else 1)
                    match_bowler_details.loc[count, 'vboDa_economy_3'] = sum(ours['runs_3']) * 6 / (sum(ours['balls_3']) if sum(ours['balls_3']) != 0 else 1)
                    match_bowler_details.loc[count, 'vboDa_economy_agg'] = sum(ours['runs']) * 6 / (sum(ours['balls']) if sum(ours['balls']) != 0 else 1)
                    match_bowler_details.loc[count, 'vboDa_dismissals_1'] =  ours['wickets_1'].mean()
                    match_bowler_details.loc[count, 'vboDa_dismissals_2'] =  ours['wickets_2'].mean()
                    match_bowler_details.loc[count, 'vboDa_dismissals_3'] =  ours['wickets_3'].mean()
                    match_bowler_details.loc[count, 'vboDa_dismissals_agg'] =  ours['wickets'].mean()
                    match_bowler_details.loc[count, 'vboDa_bowledlbw_1'] =  ours['bowledlbw_1'].mean()
                    match_bowler_details.loc[count, 'vboDa_bowledlbw_2'] =  ours['bowledlbw_2'].mean()
                    match_bowler_details.loc[count, 'vboDa_bowledlbw_3'] =  ours['bowledlbw_3'].mean()
                    match_bowler_details.loc[count, 'vboDa_bowledlbw_agg'] =  ours['bowledlbw'].mean()
                    match_bowler_details.loc[count, 'vboDa_maidens_1'] =  ours['maidens_1'].mean()
                    match_bowler_details.loc[count, 'vboDa_maidens_2'] =  ours['maidens_2'].mean()
                    match_bowler_details.loc[count, 'vboDa_maidens_3'] =  ours['maidens_3'].mean()
                    match_bowler_details.loc[count, 'vboDa_maidens_agg'] =  ours['maidens'].mean()
                ...
                if ours.empty:
                    ...
                    match_bowler_details.loc[count, 'tboDa_economy_1'] = sum(ours['runs_1']) * 6 / (sum(ours['balls_1']) if sum(ours['balls_1']) != 0 else 1)
                    match_bowler_details.loc[count, 'tboDa_economy_2'] = sum(ours['runs_2']) * 6 / (sum(ours['balls_2']) if sum(ours['balls_2']) != 0 else 1)
                    match_bowler_details.loc[count, 'tboDa_economy_3'] = sum(ours['runs_3']) * 6 / (sum(ours['balls_3']) if sum(ours['balls_3']) != 0 else 1)
                    match_bowler_details.loc[count, 'tboDa_economy_agg'] = sum(ours['runs']) * 6 / (sum(ours['balls']) if sum(ours['balls']) != 0 else 1)
                    match_bowler_details.loc[count, 'tboDa_dismissals_1'] =  ours['wickets_1'].mean()
                    match_bowler_details.loc[count, 'tboDa_dismissals_2'] =  ours['wickets_2'].mean()
                    match_bowler_details.loc[count, 'tboDa_dismissals_3'] =  ours['wickets_3'].mean()
                    match_bowler_details.loc[count, 'tboDa_dismissals_agg'] =  ours['wickets'].mean()
                    match_bowler_details.loc[count, 'tboDa_bowledlbw_1'] =  ours['bowledlbw_1'].mean()
                    match_bowler_details.loc[count, 'tboDa_bowledlbw_2'] =  ours['bowledlbw_2'].mean()
                    match_bowler_details.loc[count, 'tboDa_bowledlbw_3'] =  ours['bowledlbw_3'].mean()
                    match_bowler_details.loc[count, 'tboDa_bowledlbw_agg'] =  ours['bowledlbw'].mean()
                    match_bowler_details.loc[count, 'tboDa_maidens_1'] =  ours['maidens_1'].mean()
                    match_bowler_details.loc[count, 'tboDa_maidens_2'] =  ours['maidens_2'].mean()
                    match_bowler_details.loc[count, 'tboDa_maidens_3'] =  ours['maidens_3'].mean()
                    match_bowler_details.loc[count, 'tboDa_maidens_agg'] =  ours['maidens'].mean()
                ...
                if ours.empty:
                    ...
                    match_bowler_details.loc[count, 'fboDa_economy_1'] = sum(ours['runs_1']) * 6 / (sum(ours['balls_1']) if sum(ours['balls_1']) != 0 else 1)
                    match_bowler_details.loc[count, 'fboDa_economy_2'] = sum(ours['runs_2']) * 6 / (sum(ours['balls_2']) if sum(ours['balls_2']) != 0 else 1)
                    match_bowler_details.loc[count, 'fboDa_economy_3'] = sum(ours['runs_3']) * 6 / (sum(ours['balls_3']) if sum(ours['balls_3']) != 0 else 1)
                    match_bowler_details.loc[count, 'fboDa_economy_agg'] = sum(ours['runs']) * 6 / (sum(ours['balls']) if sum(ours['balls']) != 0 else 1)
                    match_bowler_details.loc[count, 'fboDa_dismissals_1'] =  ours['wickets_1'].mean()
                    match_bowler_details.loc[count, 'fboDa_dismissals_2'] =  ours['wickets_2'].mean()
                    match_bowler_details.loc[count, 'fboDa_dismissals_3'] =  ours['wickets_3'].mean()
                    match_bowler_details.loc[count, 'fboDa_dismissals_agg'] =  ours['wickets'].mean()
                    match_bowler_details.loc[count, 'fboDa_bowledlbw_1'] =  ours['bowledlbw_1'].mean()
                    match_bowler_details.loc[count, 'fboDa_bowledlbw_2'] =  ours['bowledlbw_2'].mean()
                    match_bowler_details.loc[count, 'fboDa_bowledlbw_3'] =  ours['bowledlbw_3'].mean()
                    match_bowler_details.loc[count, 'fboDa_bowledlbw_agg'] =  ours['bowledlbw'].mean()
                    match_bowler_details.loc[count, 'fboDa_maidens_1'] =  ours['maidens_1'].mean()
                    match_bowler_details.loc[count, 'fboDa_maidens_2'] =  ours['maidens_2'].mean()
                    match_bowler_details.loc[count, 'fboDa_maidens_3'] =  ours['maidens_3'].mean()
                    match_bowler_details.loc[count, 'fboDa_maidens_agg'] =  ours['maidens'].mean()
                ...
                # put player_id here
                match_bowler_details.loc[count,'team_name'] = player_details.loc[player,'team']
                match_bowler_details.loc[count,'opposition_name'] = player_details.loc[player,'opposition']
                match_bowler_details.loc[count,'venue_name'] = player_details.loc[player,'venue']
                ...
                match_bowler_details.loc[count,'previous_balls_involved'] = overall_bowler_details.loc[player, 'dots']
                ...
                match_bowler_details.loc[count,'previous_1haul'] = overall_bowler_details.loc[player, '1haul']
                match_bowler_details.loc[count,'previous_3haul'] = overall_bowler_details.loc[player, '3haul']
                match_bowler_details.loc[count,'previous_5haul'] = overall_bowler_details.loc[player, '5haul']
                
                match_bowler_details.loc[count,'previous_wickets'] = overall_bowler_details.loc[player, 'wickets']
                match_bowler_details.loc[count,'previous_wickets_1'] = overall_bowler_details.loc[player, 'wickets_1']
                match_bowler_details.loc[count,'previous_wickets_2'] = overall_bowler_details.loc[player, 'wickets_2']
                match_bowler_details.loc[count,'previous_wickets_3'] = overall_bowler_details.loc[player, 'wickets_3']
                match_bowler_details.loc[count,'previous_maidens'] = overall_bowler_details.loc[player, 'maidens']
                match_bowler_details.loc[count,'previous_maidens_1'] = overall_bowler_details.loc[player, 'maidens_1']
                match_bowler_details.loc[count,'previous_maidens_2'] = overall_bowler_details.loc[player, 'maidens_2']
                match_bowler_details.loc[count,'previous_maidens_3'] = overall_bowler_details.loc[player, 'maidens_3']
                match_bowler_details.loc[count,'previous_bowledlbw'] = overall_bowler_details.loc[player, 'bowledlbw']
                match_bowler_details.loc[count,'previous_bowledlbw_1'] = overall_bowler_details.loc[player, 'bowledlbw_1']
                match_bowler_details.loc[count,'previous_bowledlbw_2'] = overall_bowler_details.loc[player, 'bowledlbw_2']
                match_bowler_details.loc[count,'previous_bowledlbw_3'] = overall_bowler_details.loc[player, 'bowledlbw_3']
                
                match_bowler_details.loc[count, 'runs_1'] = player_details.loc[player, 'runs_1']
                match_bowler_details.loc[count, 'runs_2'] = player_details.loc[player, 'runs_2']
                match_bowler_details.loc[count, 'runs_3'] = player_details.loc[player, 'runs_3']
                match_bowler_details.loc[count, 'wickets_1'] = player_details.loc[player, 'wickets_1']
                match_bowler_details.loc[count, 'wickets_2'] = player_details.loc[player, 'wickets_2']
                match_bowler_details.loc[count, 'wickets_3'] = player_details.loc[player, 'wickets_3']
                match_bowler_details.loc[count, 'balls_1'] = player_details.loc[player, 'balls_1']
                match_bowler_details.loc[count, 'balls_2'] = player_details.loc[player, 'balls_2']
                match_bowler_details.loc[count, 'balls_3'] = player_details.loc[player, 'balls_3']
                match_bowler_details.loc[count, 'bowledlbw_1'] = player_details.loc[player, 'bowledlbw_1']
                match_bowler_details.loc[count, 'bowledlbw_2'] = player_details.loc[player, 'bowledlbw_2']
                match_bowler_details.loc[count, 'bowledlbw_3'] = player_details.loc[player, 'bowledlbw_3']
                match_bowler_details.loc[count, 'maidens_1'] = player_details.loc[player, 'maidens_1']
                match_bowler_details.loc[count, 'maidens_2'] = player_details.loc[player, 'maidens_2']
                match_bowler_details.loc[count, 'maidens_3'] = player_details.loc[player, 'maidens_3']
                ...
                match_bowler_details.loc[count,'balls_involved'] = player_details.loc[player,'dots']
                match_bowler_details.loc[count,'maidens'] = player_details.loc[player,'maidens']
                match_bowler_details.loc[count,'wickets'] = player_details.loc[player,'wickets']
                match_bowler_details.loc[count,'bowledlbw'] = player_details.loc[player,'bowledlbw']
                
                if match_bowler_details.loc[count,'wickets'] == 0:
                    match_bowler_details.loc[count,'strike_rate'] = 0
                else:
                    match_bowler_details.loc[count,'strike_rate'] = match_bowler_details.loc[count,'balls'] / match_bowler_details.loc[count,'wickets']
                if overall_bowler_details.loc[player, 'wickets'] + match_bowler_details.loc[count,'wickets'] == 0:
                    match_bowler_details.loc[count,'average'] = 0
                else:
                    match_bowler_details.loc[count,'average'] = (overall_bowler_details.loc[player, 'runs'] + match_bowler_details.loc[count,'runs']) / (overall_bowler_details.loc[player, 'wickets'] + match_bowler_details.loc[count,'wickets'])
                if player_details.loc[player,'overs'] == 0:
                    match_bowler_details.loc[count,'economy'] = match_bowler_details.loc[count,'runs']
                else:
                    match_bowler_details.loc[count,'economy'] = match_bowler_details.loc[count,'runs'] / player_details.loc[player,'overs']

                match_bowler_details.loc[count,'strike_rate_1'] = (overall_bowler_details.loc[player, 'balls_1'] / overall_bowler_details.loc[player, 'wickets_1']) if overall_bowler_details.loc[player, 'wickets_1'] != 0 else 0
                match_bowler_details.loc[count,'strike_rate_2'] = (overall_bowler_details.loc[player, 'balls_2'] / overall_bowler_details.loc[player, 'wickets_2']) if overall_bowler_details.loc[player, 'wickets_2'] != 0 else 0
                match_bowler_details.loc[count,'strike_rate_3'] = (overall_bowler_details.loc[player, 'balls_3'] / overall_bowler_details.loc[player, 'wickets_3']) if overall_bowler_details.loc[player, 'wickets_3'] != 0 else 0
                ...
                # NEW ONES
                match_bowler_details.loc[count,'venue_innings'] = venue_dict[venue]['innings']
                match_bowler_details.loc[count,'venue_dismissals'] = venue_dict[venue]['wickets'] / (venue_dict[venue]['innings'] if venue_dict[venue]['innings'] != 0 else 1)
                if venue_dict[venue]['balls'] != 0:
                    match_bowler_details.loc[count,'venue_economy'] = venue_dict[venue]['runs']*6 / venue_dict[venue]['balls']
                else:
                    match_bowler_details.loc[count,'venue_economy'] = 0
                if venue_dict[venue]['wickets'] != 0:
                    match_bowler_details.loc[count,'venue_average'] = venue_dict[venue]['runs'] / venue_dict[venue]['wickets']
                else:
                    match_bowler_details.loc[count,'venue_average'] = venue_dict[venue]['runs'] 
                match_bowler_details.loc[count,'venue_maidens'] = venue_dict[venue]['maidens'] / (venue_dict[venue]['innings'] if venue_dict[venue]['innings'] != 0 else 1)
                match_bowler_details.loc[count,'venue_bowledlbw'] = venue_dict[venue]['bowledlbw'] / (venue_dict[venue]['innings'] if venue_dict[venue]['innings'] != 0 else 1)


                # 'match_wickets','match_bowledlbw','match_economy','match_maidens'
                match_bowler_details.loc[count,'match_wickets'] = match_bowler_details.loc[count,'wickets']
                match_bowler_details.loc[count,'match_bowledlbw'] = match_bowler_details.loc[count,'bowledlbw']
                match_bowler_details.loc[count,'match_economy'] = match_bowler_details.loc[count,'economy']
                match_bowler_details.loc[count,'match_maidens'] = match_bowler_details.loc[count,'maidens']
                bonus = 0
                ...
                if match_bowler_details.loc[count,'match_wickets'] >= 5:
                    bonus = 16
                match_bowler_details.loc[count,'match_fantasy_points'] = 25*match_bowler_details.loc[count,'match_wickets'] + 8*match_bowler_details.loc[count,'match_bowledlbw'] + bonus + 12*match_bowler_details.loc[count,'match_maidens']
                ...
                overall_bowler_details.loc[player,'1s'] += player_details.loc[player,'1s']
                overall_bowler_details.loc[player,'2s'] += player_details.loc[player,'2s']
                overall_bowler_details.loc[player,'4s'] += player_details.loc[player,'4s']
                overall_bowler_details.loc[player,'6s'] += player_details.loc[player,'6s']
                overall_bowler_details.loc[player,'dots'] += player_details.loc[player,'dots']
                overall_bowler_details.loc[player,'balls'] += player_details.loc[player, 'balls']
                overall_bowler_details.loc[player,'balls_1'] += player_details.loc[player, 'balls_1']
                overall_bowler_details.loc[player,'balls_2'] += player_details.loc[player, 'balls_2']
                overall_bowler_details.loc[player,'balls_3'] += player_details.loc[player, 'balls_3']
                
                overall_bowler_details.loc[player,'maidens'] += player_details.loc[player,'maidens']
                overall_bowler_details.loc[player,'maidens_1'] += player_details.loc[player,'maidens_1']
                overall_bowler_details.loc[player,'maidens_2'] += player_details.loc[player,'maidens_2']
                overall_bowler_details.loc[player,'maidens_3'] += player_details.loc[player,'maidens_3']
                overall_bowler_details.loc[player,'wickets'] += player_details.loc[player,'wickets']
                overall_bowler_details.loc[player,'wickets_1'] += player_details.loc[player,'wickets_1']
                overall_bowler_details.loc[player,'wickets_2'] += player_details.loc[player,'wickets_2']
                overall_bowler_details.loc[player,'wickets_3'] += player_details.loc[player,'wickets_3']
                overall_bowler_details.loc[player,'bowledlbw'] += player_details.loc[player,'bowledlbw']
                overall_bowler_details.loc[player,'bowledlbw_1'] += player_details.loc[player,'bowledlbw_1']
                overall_bowler_details.loc[player,'bowledlbw_2'] += player_details.loc[player,'bowledlbw_2']
                overall_bowler_details.loc[player,'bowledlbw_3'] += player_details.loc[player,'bowledlbw_3']
                ...
                if player_details.loc[player,'wickets'] >= 1 and player_details.loc[player,'wickets'] < 4:
                    overall_bowler_details.loc[player,'1haul'] += 1
                if player_details.loc[player,'wickets'] >= 3 and player_details.loc[player,'wickets'] < 5:
        ...
        for i in range(len(match_bowler_details)):
            ...
            if not matched.empty:
                match_bowler_details.iloc[i, match_bowler_details.columns.get_loc('player_id')] = matched['identifier'].values[0]
            else:
                # print(f"No matching entry for {name}: {len(mapping[mapping['unique_name'] == name])} matches")
                match_bowler_details.iloc[i, match_bowler_details.columns.get_loc('player_id')] = 'xxxxxxxx'
        
        
        target_columns = ['match_wickets','match_bowledlbw','match_economy','match_maidens','match_fantasy_points']
        for target_column in target_columns:
            if target_column in match_bowler_details.columns:
                new_column_name = f"{format}_{target_column}"
                match_bowler_details.rename(columns={target_column: new_column_name}, inplace=True)
            else:
        ...
        for index, row in match_bowler_details.iterrows():
            ...
            if player not in overs:
                overs[player] = 0
            match_bowler_details.loc[index, 'consistency'] = 0.4174*overs[player] + 0.2634*row['innings_played'] + 0.1602*row['previous_strike_rate'] + 0.0975*row['previous_average'] + 0.0615*row['previous_5haul']
            overs[player] += row['balls'] // 6
            
            indices = match_bowler_details[(match_bowler_details['player_name'] == player) & (match_bowler_details.index < index)].index
            if len(indices) == 0:
                ...
                avg = ((cur['runs']-old['runs']) / (cur['wickets']-old['wickets'])) if (cur['wickets']-old['wickets']) != 0 else 0
                sr = ((cur['balls']-old['balls']) / (cur['wickets']-old['wickets'])) if (cur['wickets']-old['wickets']) != 0 else 0
                match_bowler_details.loc[index, 'form'] = 0.3269*((cur['balls']-old['balls'])//6) + 0.2486*min(10, len(indices)) + 0.1877*sr + 0.1210*avg + 0.0798*(cur['previous_5haul']-old['previous_5haul'])
            ...
            try:
                sr = opposition_dict[player][opposition]['balls'] / opposition_dict[player][opposition]['wickets']
            except:
                sr = 0
            try:
                avg = opposition_dict[player][opposition]['runs'] / opposition_dict[player][opposition]['wickets']
            except:
                avg = 0
            match_bowler_details.loc[index, 'opposition'] = 0.3177*opposition_dict[player][opposition]['overs'] + 0.3177*opposition_dict[player][opposition]['innings'] + 0.1933*sr + 0.1465*avg + 0.0943*opposition_dict[player][opposition]['5hauls']
            ...
            try:
                sr = venue_dict[player][venue]['balls'] / venue_dict[player][venue]['wickets']
            except:
                sr = 0
            try:
                avg = venue_dict[player][venue]['runs'] / venue_dict[player][venue]['wickets']
            except:
                avg = 0
            match_bowler_details.loc[index, 'venue'] = 0.3018*venue_dict[player][venue]['overs'] + 0.2783*venue_dict[player][venue]['innings'] + 0.1836*sr + 0.1391*avg + 0.0972*venue_dict[player][venue]['5hauls']
